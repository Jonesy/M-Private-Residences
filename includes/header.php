...
<head>
  ...
  <script src="scripts/fixtures/home.js"></script>
  <?php endif; ?>
  <?php if ($file == 'experience.php'): ?>
  <script src="scripts/fixtures/experience.js"></script>
  <?php endif; ?>
  <?php if ($file == 'content.php'): ?>
  <script src="scripts/fixtures/residence.js"></script>
  <?php endif; ?>
</head>
<?php 
if ($file == 'index.php'):
      ...
      <div class="container">
        ...
        <nav>
          <ul id="nav" class="main-nav">
            <li><a href="#" class="subnav selected" data-target="#subnav-experiences">Experiences <i><img src="images/svg/caret.svg" alt=""></i></a></li>
